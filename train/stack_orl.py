...
for seed in seeds:
    ...
    for p, r in pr_lst:
        ...
        record_SNMF_ORL.append(((p,r), acc, nmi, rre, tol, step, seed, timeusing, peak_mem, Algo, Data))

df_SNMF_ORL = pd.DataFrame(record_SNMF_ORL, columns=['(p,r)','acc','nmi','rre','tol','step','seed', 'time', 'memory', 'Algo', 'Data'])
print(df_SNMF_ORL)
...
df_SNMF_ORL.to_excel(f'{Algo}_{Data}_Raw.xlsx', index=True)
