...
for seed in seeds:
    ...
    for delta in deltas:
        for p, r in pr_lst:
            ...
            record_HC_ORL.append(((p,r), delta, acc, nmi, rre, tol, step, seed, timeusing, peak_mem, Algo, Data))

df_HC_ORL = pd.DataFrame(record_HC_ORL, columns=['(p,r)','delta','acc','nmi','rre','tol','step','seed', 'time', 'memory', 'Algo', 'Data'])
print(df_HC_ORL)
...
print(summary)
df_HC_ORL.to_excel(f'{Algo}_{Data}_Raw.xlsx', index=True)
