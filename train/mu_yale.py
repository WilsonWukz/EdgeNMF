...
for seed in seeds:
    ...
    for p, r in pr_lst:
        ...
        record_MU_Yale.append(((p,r), acc, nmi, rre, tol, step, seed, timeusing, peak_mem, Algo, Data))

df_MU_Yale = pd.DataFrame(record_MU_Yale, columns=['(p,r)','acc','nmi','rre','tol','step','seed', 'time', 'memory', 'Algo', 'Data'])
print(df_MU_Yale)
...
print(summary)
df_MU_Yale.to_excel(f'{Algo}_{Data}_Raw.xlsx', index=True)
