...
for seed in seeds:
    ...
    for p, r in pr_lst:
        ...
        record_L2_ORL.append(((p,r), acc, nmi, rre, lr, tol, step, seed, timeusing, peak_mem, Algo, Data))

df_L2_ORL = pd.DataFrame(record_L2_ORL, columns=['(p,r)','acc','nmi','rre','lr','tol','step','seed', 'time', 'memory', 'Algo', 'Data'])
print(df_L2_ORL)
...
print(summary)
df_L2_ORL.to_excel(f'{Algo}_{Data}_Raw.xlsx', index=True)
