...
## 🚀 Key Features
- **Robustness**: Implementation of L1-NMF via IRLS for high impulse noise tolerance.
- **Efficiency**: Optimized for edge deployment with low memory footprint (~35% reduction).
- **Benchmark**: Comprehensive comparison of 5 NMF variants (L2, MU, L1, HC, StackMU).
...
Run `main.py` to reproduce the experiments on ORL and YaleB datasets.
